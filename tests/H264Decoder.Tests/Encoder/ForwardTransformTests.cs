...
public class ForwardTransformTests
{
    ...
    public void Forward4x4_FollowedByInverse4x4_RecoversInput_AfterDequant()
    {
        ...
        H264Decoder.Transform.Quantization_DequantPublic.Dequant4x4Ac(block, qP: 18);
        H264Decoder.Transform.InverseTransform.Inverse4x4(block);
    ...
    public void ForwardHadamard4x4_FollowedByInverseHadamard4x4_Is16xIdentity()
    {
        ...
        H264Decoder.Transform.InverseTransform.InverseHadamard4x4(dc);
