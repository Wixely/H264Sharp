// <auto-generated>
// CABAC context init table ported from Cisco OpenH264 (BSD-2-Clause)
// common_tables.cpp / g_kiCabacGlobalContextIdx.
// Re-generate with: dotnet run --project tools/CavlcGen
// </auto-generated>

namespace H264Decoder.Cabac;

internal static class CabacInitTable
{
    public const int ContextCount = 460;
    public const sbyte CtxNA = -128;

    /// <summary>m,n for each (ctxIdx, model). Model 0 = I-slice; models 1..3 = P-slice with cabac_init_idc 0..2.</summary>
    public static readonly sbyte[,,] MN = new sbyte[460, 4, 2]
    {
        ...
        { { -1, 54 }, { -1, 54 }, { -1, 54 }, { -1, 54 } },
        { { 7, 51 }, { 7, 51 }, { 7, 51 }, { 7, 51 } },
        { { -128, -128 }, { 23, 33 }, { 22, 25 }, { 29, 16 } },
        { { -128, -128 }, { 23, 2 }, { 34, 0 }, { 25, 0 } },
        { { -128, -128 }, { 21, 0 }, { 16, 0 }, { 14, 0 } },
        { { -128, -128 }, { 1, 9 }, { -2, 9 }, { -10, 51 } },
        { { -128, -128 }, { 0, 49 }, { 4, 41 }, { -3, 62 } },
        { { -128, -128 }, { -37, 118 }, { -29, 118 }, { -27, 99 } },
        { { -128, -128 }, { 5, 57 }, { 2, 65 }, { 26, 16 } },
        { { -128, -128 }, { -13, 78 }, { -6, 71 }, { -4, 85 } },
        { { -128, -128 }, { -11, 65 }, { -13, 79 }, { -24, 102 } },
        { { -128, -128 }, { 1, 62 }, { 5, 52 }, { 5, 57 } },
        { { -128, -128 }, { 12, 49 }, { 9, 50 }, { 6, 57 } },
        { { -128, -128 }, { -4, 73 }, { -3, 70 }, { -17, 73 } },
        { { -128, -128 }, { 17, 50 }, { 10, 54 }, { 14, 57 } },
        { { -128, -128 }, { 18, 64 }, { 26, 34 }, { 20, 40 } },
        { { -128, -128 }, { 9, 43 }, { 19, 22 }, { 20, 10 } },
        { { -128, -128 }, { 29, 0 }, { 40, 0 }, { 29, 0 } },
        { { -128, -128 }, { 26, 67 }, { 57, 2 }, { 54, 0 } },
        { { -128, -128 }, { 16, 90 }, { 41, 36 }, { 37, 42 } },
        { { -128, -128 }, { 9, 104 }, { 26, 69 }, { 12, 97 } },
        { { -128, -128 }, { -46, 127 }, { -45, 127 }, { -32, 127 } },
        { { -128, -128 }, { -20, 104 }, { -15, 101 }, { -22, 117 } },
        { { -128, -128 }, { 1, 67 }, { -4, 76 }, { -2, 74 } },
        { { -128, -128 }, { -13, 78 }, { -6, 71 }, { -4, 85 } },
        { { -128, -128 }, { -11, 65 }, { -13, 79 }, { -24, 102 } },
        { { -128, -128 }, { 1, 62 }, { 5, 52 }, { 5, 57 } },
        { { -128, -128 }, { -6, 86 }, { 6, 69 }, { -6, 93 } },
        { { -128, -128 }, { -17, 95 }, { -13, 90 }, { -14, 88 } },
        { { -128, -128 }, { -6, 61 }, { 0, 52 }, { -6, 44 } },
        { { -128, -128 }, { 9, 45 }, { 8, 43 }, { 4, 55 } },
        { { -128, -128 }, { -3, 69 }, { -2, 69 }, { -11, 89 } },
        { { -128, -128 }, { -6, 81 }, { -5, 82 }, { -15, 103 } },
        { { -128, -128 }, { -11, 96 }, { -10, 96 }, { -21, 116 } },
        { { -128, -128 }, { 6, 55 }, { 2, 59 }, { 19, 57 } },
        { { -128, -128 }, { 7, 67 }, { 2, 75 }, { 20, 58 } },
        { { -128, -128 }, { -5, 86 }, { -3, 87 }, { 4, 84 } },
        { { -128, -128 }, { 2, 88 }, { -3, 100 }, { 6, 96 } },
        { { -128, -128 }, { 0, 58 }, { 1, 56 }, { 1, 63 } },
        { { -128, -128 }, { -3, 76 }, { -3, 74 }, { -5, 85 } },
        { { -128, -128 }, { -10, 94 }, { -6, 85 }, { -13, 106 } },
        { { -128, -128 }, { 5, 54 }, { 0, 59 }, { 5, 63 } },
        { { -128, -128 }, { 4, 69 }, { -3, 81 }, { 6, 75 } },
        { { -128, -128 }, { -3, 81 }, { -7, 86 }, { -3, 90 } },
        { { -128, -128 }, { 0, 88 }, { -5, 95 }, { -1, 101 } },
        { { -128, -128 }, { -7, 67 }, { -1, 66 }, { 3, 55 } },
        { { -128, -128 }, { -5, 74 }, { -1, 77 }, { -4, 79 } },
        { { -128, -128 }, { -4, 74 }, { 1, 70 }, { -2, 75 } },
        { { -128, -128 }, { -5, 80 }, { -2, 86 }, { -12, 97 } },
        { { -128, -128 }, { -7, 72 }, { -5, 72 }, { -7, 50 } },
        { { -128, -128 }, { 1, 58 }, { 0, 61 }, { 1, 60 } },
        { { 0, 41 }, { 0, 41 }, { 0, 41 }, { 0, 41 } },
        { { 0, 63 }, { 0, 63 }, { 0, 63 }, { 0, 63 } },
        { { 0, 63 }, { 0, 63 }, { 0, 63 }, { 0, 63 } },
        { { 0, 63 }, { 0, 63 }, { 0, 63 }, { 0, 63 } },
