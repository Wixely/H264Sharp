...
using H264Sharp.Encoder.Cabac;
using H264Sharp.Encoder.Mode;
using H264Sharp.Encoder.Syntax;
using H264Sharp.Decoder.Syntax;

namespace H264Sharp.Encoder;
...
public static class H264FrameEncoder
{
        ...
        MacroblockEncoderState?[]? mbStatesOut = null)
    {
        ...
        H264Sharp.Decoder.Cabac.CabacEncoder? cabac = null;
        ...
        if (options.EnableCabac)
        {
            ...
            {
                sbyte m = H264Sharp.Decoder.Cabac.CabacInitTable.MN[ctxIdx, model, 0];
                sbyte n = H264Sharp.Decoder.Cabac.CabacInitTable.MN[ctxIdx, model, 1];
                if (m == H264Sharp.Decoder.Cabac.CabacInitTable.CtxNA) continue;
                contexts.Initialize(ctxIdx, m, n, qp);
            }
            cabac = new H264Sharp.Decoder.Cabac.CabacEncoder(contexts);
        }
        ...
        MacroblockEncoderState?[]? mbStatesOut = null)
    {
        ...
        var cabac = new H264Sharp.Decoder.Cabac.CabacEncoder(contexts);
        ...
        for (int addr = 0; addr < totalMbs; addr++)
        {
            ...
            if (useIntra4x4)
            {
                H264Sharp.Encoder.Cabac.CabacMbEncoder.EncodeIntra4x4(
                    cabac,
                    mbSrcY, mbSrcU, mbSrcV,
                    srcStrideY: bufferWidth, srcStrideC: bufferChromaWidth,
                    reconYOut, reconUOut, reconVOut,
            ...
            {
                H264Sharp.Encoder.Cabac.CabacMbEncoder.EncodeIntra16x16(
                    cabac,
                    mbSrcY, mbSrcU, mbSrcV,
                    srcStrideY: bufferWidth, srcStrideC: bufferChromaWidth,
                    reconYOut, reconUOut, reconVOut,
            ...
            H264Sharp.Encoder.Cabac.CabacEncSlice.EncodeEndOfSliceFlag(cabac, last);
        }
