...
public static class Commands
{
    ...
    public static int Run(string[] args, TextWriter stdout, TextWriter stderr)
    {
        ...
        stderr.WriteLine("  h264sharp encode <in.yuv> <out.h264> --size <W>x<H> [--frames N] [--qp 18]");
        stderr.WriteLine("  h264sharp <in.h264|in.mp4> <out.yuv|out.png>");
        stderr.WriteLine("  h264sharp <in.mp4> <out.png> --at <seconds>");
        stderr.WriteLine("  h264sharp <in.mp4> <out.png> --at-pct <0..1>");
        stderr.WriteLine("  h264sharp <in.mp4> <out_dir> --frames <spec>");
        stderr.WriteLine("    spec: 'all', '<N>', '<N>-<M>', or comma-separated mix (e.g. '5,10-15,20')");
        stderr.WriteLine("  h264sharp --info <in.mp4>");
        return 1;
    }
    ...
    public static int EncodeYuv(string[] args, TextWriter stderr)
    {
        ...
        var opts = new H264Sharp.Encoder.H264FrameEncoder.Options
        {
            EnableIntra4x4 = enableIntra4x4,
            EnableCabac = enableCabac,
        };
        byte[] annexB = H264Sharp.Encoder.H264FrameEncoder.EncodeAnnexB(yuv, width, height, qp, frames, opts);
